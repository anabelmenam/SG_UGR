...
import { ExamenH, ExamenI, ExamenJ } from './Examen.js'
...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.examenH = new ExamenH(this.gui, "Controles del modelo");
    this.add (this.examenH);
    this.examenI = new ExamenI(this.gui, "Controles del modelo 2");
    this.add (this.examenI);
    this.examenJ = new ExamenJ(this.gui, "Controles del modelo 3");
    this.add(this.examenJ);
  }
