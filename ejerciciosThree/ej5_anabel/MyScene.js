...
import { Taza, Visagra, Tuerca } from './OperacionesBooleanas.js'
...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.axis2.position.set(4, 0, 0);
    this.add (this.axis2);

    this.axis3 = new THREE.AxesHelper (2);
    this.axis3.position.set(-4, 0, 0);
    this.add (this.axis3);
    ...
    this.taza = new Taza(this.gui, "Controles del modelo");
    this.add (this.taza);
    this.visagra = new Visagra(this.gui, "Controles del modelo 2");
    this.add (this.visagra);
    this.tuerca = new Tuerca(this.gui, "Controles del modelo 3");
