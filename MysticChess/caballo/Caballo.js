...
class Caballo extends THREE.Object3D {
    constructor(gui, titleGui) {
        ...
        this.figura = evaluador.evaluate(cabeza, ojo1, CSG.SUBTRACTION);
        ...
        this.figura = this.figura.geometry;
        this.figura.scale(0.7,0.7,0.7)
        this.figura.translate(0, 2.5, -1.25);
        this.figura.rotateY(Math.PI/2);

        this.figura = new CSG.Brush(this.figura, this.material);
        this.figura = evaluador.evaluate(this.figura, base, CSG.ADDITION);
