...
class Reina extends Pieza {
    ...
    generarGeometria() {
        ...
        this.figura = evaluador.evaluate(cuerpo2, cuerpo, CSG.ADDITION);
    ...
    generarCabeza(material) {
        ...
        var evaluador = new CSG.Evaluator();
        this.cabeza = evaluador.evaluate(cilindro, recorte1, CSG.SUBTRACTION);
        this.cabeza = evaluador.evaluate(this.cabeza, recorte2, CSG.SUBTRACTION);
        this.cabeza = evaluador.evaluate(this.cabeza, recorte3, CSG.SUBTRACTION);
        this.cabeza = evaluador.evaluate(this.cabeza, recorte4, CSG.SUBTRACTION);
        this.cabeza = evaluador.evaluate(this.cabeza, recorte5, CSG.SUBTRACTION);
        this.cabeza = evaluador.evaluate(this.cabeza, esfera, CSG.ADDITION);
        this.cabeza = evaluador.evaluate(this.cabeza, cabezal, CSG.ADDITION);

        var geometria = this.cabeza.geometry;
        return geometria;
    }
