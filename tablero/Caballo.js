...
class Caballo extends Pieza {
    ...
    generarGeometria() {
        ...
        var geometriaCaballo = geometry_base;
    ...
    generarCabeza(material) {
        ...
        figura.geometry.scale(0.8,0.8,0.8)
        figura.geometry.translate(-0.5, 1.5, -1.5);
        figura.geometry.rotateY(Math.PI/2);

        return figura.geometry;
    }
