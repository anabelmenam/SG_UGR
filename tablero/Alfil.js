...
class Alfil extends Pieza {
    ...
    generarGeometria() {
        ...
        var alfil = evaluador.evaluate(cuerpo, cuello, CSG.ADDITION);
    ...
    generarCabeza(material) {
        ...
        var geometriaCabeza = this.createCabeza();
        geometriaCabeza = new CSG.Brush(geometriaCabeza, material);
        ...
        var cabezaBrush = evaluador.evaluate(geometriaCabeza, bolaCabeza, CSG.ADDITION);
        cabezaBrush = evaluador.evaluate(cabezaBrush, corte, CSG.SUBTRACTION);
        return cabezaBrush.geometry;
    }
