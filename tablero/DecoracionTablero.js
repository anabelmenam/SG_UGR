...
class DecoracionTablero extends THREE.Object3D {
    constructor() {
        ...
        const texturaMadera = loader.load('./texturas/madera.jpg'); 
        ...
        const texturaPared = loader.load('./texturas/pared.png');
        ...
        const texturaTorre = loader.load('./texturas/pared.png');
        ...
        const materialMorado = new THREE.MeshStandardMaterial({
            color: 0x800080
        });
        ...
        const materialTorre = new THREE.MeshStandardMaterial({
            map: texturaTorre,
        });
        ...
        var dec = new CSG.Brush(geometry, materialMadera);

        var geometry1 = new THREE.ExtrudeGeometry( shape1, extrudeSettings );
        var dec1 = new CSG.Brush(geometry1, materialMorado);

        var borrar = new THREE.BoxGeometry(8.2,8.2,1);
        borrar = new CSG.Brush(borrar, materialMadera);

        var borrar1 = new THREE.BoxGeometry(8,8,1);
        borrar1 = new CSG.Brush(borrar1, materialMorado);
        ...
        pared1 = new THREE.Mesh(pared1, materialPared);
        pared2 = new THREE.Mesh(pared2, materialPared);
        pared3 = new THREE.Mesh(pared3, materialPared);
        pared4 = new THREE.Mesh(pared4, materialPared);
        figura = new THREE.Mesh(figura, materialMadera);
        figura1 = new THREE.Mesh(figura1, materialMorado);


        const torre1 = new THREE.Mesh(this.crearTorre(materialPared), materialTorre);
        torre1.position.set(5.35, 5.35, 0.25);

        const torre2 = new THREE.Mesh(this.crearTorre(materialPared), materialTorre);
        torre2.position.set(-5.35, 5.35, 0.25);

        const torre3 = new THREE.Mesh(this.crearTorre(materialPared), materialTorre);
        torre3.position.set(5.35, -5.35, 0.25);

        const torre4 = new THREE.Mesh(this.crearTorre(materialPared), materialTorre);
    ...
    crearPared( textura) {
        ...
        pared.computeBoundingBox();
        pared.computeBoundingSphere();
        pared.computeUVs?.(); 
    ...
    crearTorre(material) {
        ...
        const geometriaTorre = torre.geometry;
        geometriaTorre.computeVertexNormals();
        geometriaTorre.computeBoundingBox();
        geometriaTorre.computeBoundingSphere();
        geometriaTorre.computeUVs?.(); 
